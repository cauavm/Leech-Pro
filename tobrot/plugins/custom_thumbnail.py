...
async def save_thumb_nail(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            "✅ Thumbnail do vídeo / arquivo salvada. "
            + "Esta imagem irá ser utilizada nos Uploads até /clearthumbnail."
        )
    else:
        await ismgs.edit("❌ Responda à uma foto para salvar a Thumbnail")
...
async def clear_thumb_nail(client, message):
    ...
    if os.path.exists(thumb_image_path):
        ...
        await ismgs.edit("✅ Thumbnail customizada limpada com sucesso.")
    else:
        await ismgs.edit("❌ Nada para limpar.")
